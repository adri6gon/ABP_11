...
<h2 style="color:white;">Introducir resultado:</h2>
				<div style="overflow-x:auto;color:white;">
					<form name="resultado" id="resultadoEnfren" action="./CLASIFICACION_Controller.php?action=RESULTADO" onChange="validarEditarUser()" onLoad="validarEditarUser()" method="POST" enctype="multipart/form-data" onsubmit="return encriptar()">
						 <table>
							<tr>
								<td>IdEnfrentamientoRonda: </td>
								<td><input class="form-est" type="text" id="idEnfrentamientoRonda" name="idEnfrentamientoRonda" size="9" maxlength="9" placeholder="IdEnfrentamiento*" value="<? echo $this->datos['idEnfrentamientoRonda']?>" onBlur="comprobarTexto(this,this.size)" required readonly></td>
							</tr>
							<tr>
								<td>Pareja1:</td>
