	...
	Switch ($_REQUEST['action']){
        ...
        //Si tiene permisos
			if(comprobarRol('admin')){
				if (!$_POST){//Si viene vacio
                    ...
                    //Nueva vista search
					new SEARCH_ENFRENTAMIENTO('../ContidPareja1lers/ENFRENTAMIENTOS_ContidPareja1ler.php');
				}
				else{
                    ...
                    //Si tiene grupo
						...
						//var_dump($datos);
                    //Nueva vista showall
					new ENFRENTAMIENTO_SHOWALL(true,$lista, $datos, '../ContidPareja1lers/ENFRENTAMIENTOS_ContidPareja1ler.php?action=SEARCH');
				}
        ...
        //Si tiene permisos 
			if(comprobarRol('admin')){
                ...
                //Nueva vista
				new ENFRENTAMIENTO_SHOWCURRENT($valores,'../ContidPareja1lers/ENFRENTAMIENTOS_ContidPareja1ler.php',$lista);
			}else{//Si no tiene permisos
				new MESSAGE($alerta,'../index.php');
			}
				break;
